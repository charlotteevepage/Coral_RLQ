...
# Q Matrix 
# #########
# Site (rows) x species traits (columns)

# Extract traits of interest from coral database


# a) Downloads traits of interest 
# b) Determine if traits are numeric or if they are factors. 
